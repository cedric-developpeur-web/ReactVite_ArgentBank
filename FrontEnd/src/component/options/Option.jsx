...
const Option = () => {
  return (
    <section id='features'>
      <div>
        <img src={iconChat} alt="logo qui reprenste l'image d'un chat" />
      ...
      <div>
        <img src={iconMoney} alt="logo de billet en dollar" />
        <h3>More savings mean higher rates</h3>
        <p>The more you save with us, the higher your interest rate will be!</p>
      </div>
      <div>
        <img src={iconSecurity} alt="logo indiquant donnee securiser" />
